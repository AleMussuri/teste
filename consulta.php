                ...
                <table id="cadastros" class="row-border compact stripe hover">
                 ...
                 ?>
                    <tr>
                        ...
                        <td><a  title="Editar"href="editar.php?id=<?php  echo $row['id']; ?>"><i
                                    class="fa fa-pencil" aria-hidden="true"></i><button type="button" class="btn btn-outline-success">Editar</button>
                            </a></td>
                        <td><a title="Apagar" href="deleta.php?id=<?php  echo $row['id']; ?>"><i
                                    class="fa fa-trash" aria-hidden="true"></i><button type="button" class="btn btn-outline-danger">Excluir</button>
                            </a></td>
                    </tr>
                    <?php
                    }
